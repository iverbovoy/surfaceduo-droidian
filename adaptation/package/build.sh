...
# The patched phosh (../shell/phosh-patches 0001-0015), built per
...
# The patched phoc (../shell/phoc-patches/0001-0014): tiled windows stop
...
# catcher over an empty panel pulls that panel's shade. Version-locked like phosh:
